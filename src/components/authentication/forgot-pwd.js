      ...
      <Form>
        <Form.Item>
          ...
          {getFieldDecorator('userName', {
            ...
            <Input
              prefix={<Icon type='user' style={styles.field} />}
        ...
        <Form.Item>
          ...
          {getFieldDecorator('codeNumber', {
            rules: [
              {
                required: true,
                message: 'Please enter code number send to your email!'
              }
            ]
          })(
            <Input
              prefix={<Icon type='number' style={styles.field} />}
              placeholder='Code'
            />
          )}
        </Form.Item>
...
const WrappeForgotPasswordForm = Form.create({ name: 'normal_login' })(
  ForgotPwd
);
