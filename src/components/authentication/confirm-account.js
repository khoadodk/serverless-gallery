  ...
  confirmRegistrationCode = async () => {
    ...
    form.validateFields(async (err, values) => {
      ...
      if (!err) {
        ...
        let error = await this.props.confirmRegistration(
          this.props.username,
          values.code
        );
        ...
        if (error) {
          ...
          this.props.switchAuthenticationForm(
      ...
      <Form>
        <Form.Item>
          ...
          {getFieldDecorator('code', {
            ...
            <Input
              prefix={<Icon type='check-square' style={styles.field} />}
        ...
        <Form.Item>
          ...
          <Button
            type='primary'
            onClick={this.confirmRegistrationCode}
        ...
        <Form.Item>
          ...
          <Button
            ...
            className='login-form-button'>
            <Icon type='clock-circle' style={styles.field} />
            Resend Confirmation
          </Button>
        </Form.Item>
        <Form.Item>
...
const WrappeConfirmAccountForm = Form.create({ name: 'normal_login' })(
  ConfirmAccount
);
